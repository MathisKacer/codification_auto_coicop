"""
Utilitaires d'affichage pour les rapports de stats descriptives COICOP du
site Quarto (`site/stats-descriptives/`) : libelles lisibles pour les
classifieurs/colonnes/divisions, et mise en forme des tableaux.

NB : `rapport_stat_des/rapport_stats_descriptives.py` (rapport autonome,
hors site) a sa propre copie de ce module -- voir la note d'independance en
tete de ce fichier -- pour rester utilisable sans dependre de `src/`.
"""
import pandas as pd
